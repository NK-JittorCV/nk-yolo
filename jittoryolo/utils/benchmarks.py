...
Usage:
    from jittoryolo.utils.benchmarks import ProfileModels, benchmark
...
from jittoryolo import YOLO, YOLOWorld
from jittoryolo.cfg import TASK2DATA, TASK2METRIC
from jittoryolo.utils import ARM64, ASSETS, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from jittoryolo.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from jittoryolo.utils.downloads import safe_download
from jittoryolo.utils.files import file_size
from jittoryolo.utils.jittor_utils import get_cpu_info, select_device
...
class RF100Benchmark:
    ...
    def parse_dataset(self, ds_link_txt="datasets_links.txt"):
        ...
        os.chdir("rf-100")
        os.mkdir("jittoryolo-benchmarks")
        safe_download("https://github.com/jittoryolo/assets/releases/download/v0.0.0/datasets_links.txt")
...
class ProfileModels:
    ...
    def __init__(
        ...
        self.device = device or jt.device(0 if jt.cuda.is_available() else "cpu")
    ...
    def print_table(table_rows):
        ...
        gpu = jt.cuda.get_device_name(0) if jt.cuda.is_available() else "GPU"
        headers = [
            "Model",
            "size<br><sup>(pixels)",
