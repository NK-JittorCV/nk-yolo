...
# PyTorch functions ----------------------------------------------------------------------------------------------------
_torch_load = jt.load  # copy to avoid recursion errors
_torch_save = jt.save
...
def torch_load(*args, **kwargs):
    ...
    This function wraps jt.load and adds the 'weights_only' argument for PyTorch 1.13.0+ to prevent warnings.
    ...
    """
    from jittoryolo.utils.jittor_utils import TORCH_1_13
