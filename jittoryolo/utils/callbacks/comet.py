...
from jittoryolo.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from jittoryolo.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
try:
    ...
    # Names of plots created by jittoryolo that are logged to Comet
...
def _get_comet_model_name():
    """Returns the model name for Comet from the environment variable COMET_MODEL_NAME or defaults to 'jittoryolo'."""
    return os.getenv("COMET_MODEL_NAME", "jittoryolo")
...
def _create_experiment(args):
    ...
    try:
        ...
        experiment.log_other("Created from", "jittoryolo")
...
def on_fit_epoch_end(trainer):
    ...
    if curr_epoch == 1:
        from jittoryolo.utils.jittor_utils import model_info_for_loggers
