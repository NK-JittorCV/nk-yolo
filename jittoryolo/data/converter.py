...
from jittoryolo.utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
...
def convert_coco(
    ...
    Example:
        ```python
        from jittoryolo.data.converter import convert_coco
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    ...
    Example:
        ```python
        from jittoryolo.data.converter import convert_segment_masks_to_yolo_seg
    ...
    for mask_path in Path(masks_dir).iterdir():
        if mask_path.suffix == ".png":
            ...
            # Save jittoryolo YOLO format data to file
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from jittoryolo.data.converter import convert_dota_to_yolo_obb
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from jittoryolo.data.converter import create_synthetic_coco_dataset
