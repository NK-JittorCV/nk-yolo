...
from jittoryolo.utils import LOCAL_RANK, NUM_THREADS, TQDM, colorstr
from jittoryolo.utils.ops import resample_segments
...
# jittoryolo dataset *.cache version, >= 1.0.0 for YOLOv8
