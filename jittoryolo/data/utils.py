...
from jittoryolo.utils.checks import check_file, check_font, is_ascii
...
class HUBDatasetStats:
    ...
    def get_json(self, save=False, verbose=False):
        """Return dataset JSON for jittoryolo HUB."""
        ...
        for split in "train", "val", "test":
            ...
            if self.task == "classify":
                ...
                from jittoryolo.data import YOLODataset
    ...
    def process_images(self):
        """Compress images for jittoryolo HUB."""
        from jittoryolo.data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Example:
        ```python
        from pathlib import Path
        from jittoryolo.data.utils import compress_one_image
...
def autosplit(path=DATASETS_DIR / "coco8/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Example:
        ```python
        from jittoryolo.data.utils import autosplit
...
def save_dataset_cache_file(prefix, path, x, version):
    """Save an jittoryolo dataset *.cache dictionary x to path."""
