...
from jittoryolo.data import YOLOConcatDataset, build_grounding, build_yolo_dataset
from jittoryolo.data.utils import check_det_dataset
from jittoryolo.models.yolo.world import WorldTrainer
from jittoryolo.utils import DEFAULT_CFG
...
class WorldTrainerFromScratch(WorldTrainer):
    ...
    Example:
        ```python
        from jittoryolo.models.yolo.world.train_world import WorldTrainerFromScratch
        from jittoryolo import YOLOWorld
