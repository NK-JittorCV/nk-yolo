...
from jittoryolo.utils.metrics import OKS_SIGMA, PoseMetrics, box_iou, kpt_iou
...
class PoseValidator(DetectionValidator):
    ...
    Example:
        ```python
        from jittoryolo.models.yolo.pose import PoseValidator
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        ...
        if isinstance(self.args.device, str) and self.args.device.lower() == "mps":
            LOGGER.warning(
                ...
                "See https://github.com/jittoryolo/jittoryolo/issues/4031."
            )
    ...
    def update_metrics(self, preds, batch):
        ...
        for si, pred in enumerate(preds):
            ...
            stat = dict(
                ...
                tp_p=jt.zeros(npr, self.niou, dtype=jt.bool, device=self.device),
            )
    ...
    def plot_predictions(self, batch, preds, ni):
        ...
        pred_kpts = jt.concat([p[:, 6:].view(-1, *self.kpt_shape) for p in preds], 0)
        plot_images(
            batch["img"],
