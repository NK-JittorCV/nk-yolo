...
This module provides an interface to the Segment Anything Model (SAM) from jittoryolo, designed for real-time image
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from jittoryolo, designed for
    ...
    def task_map(self):
        ...
        Examples:
            ...
            >>> print(task_map)
            {'segment': <class 'jittoryolo.models.sam.predict.Predictor'>}
        """
