...
class RTDETR(Model):
    ...
    def task_map(self) -> dict:
        """
        Returns a task map for RT-DETR, associating tasks with corresponding jittoryolo classes.

        Returns:
            dict: A dictionary mapping task names to jittoryolo task classes for the RT-DETR model.
        """
        return {
            "detect": {
