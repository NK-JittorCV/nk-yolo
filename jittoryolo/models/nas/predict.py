...
class NASPredictor(BasePredictor):
    """
    jittoryolo YOLO NAS Predictor for object detection.

    This class extends the `BasePredictor` from jittoryolo engine and is responsible for post-processing the
    ...
    def postprocess(self, preds_in, img, orig_imgs):
        ...
        preds = jt.concat((boxes, preds_in[0][1]), -1).permute(0, 2, 1)
