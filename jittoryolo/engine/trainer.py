...
from jittoryolo.utils.autobatch import check_train_batch_size
from jittoryolo.utils.checks import check_amp, check_file, check_imgsz, check_model_file_from_stem, print_args
from jittoryolo.utils.dist import ddp_cleanup, generate_ddp_command
from jittoryolo.utils.files import get_latest_run
...
class BaseTrainer:
        ...
        for k, v in self.model.named_parameters():
            ...
            # 增加对BatchNorm参数的特殊处理
                ...
                LOGGER.info(
                    ...
                    "See jittoryolo.engine.trainer for customization of frozen layers."
                )
    ...
    def save_model(self):
        ...
        # Serialize ckpt to a byte buffer once (faster than repeated jt.save() calls)
        buffer = io.BytesIO()
        jt.save(
            {
                "epoch": self.epoch,
                ...
                "version": __version__,
                "license": "AGPL-3.0 (https://jittoryolo.com/license)",
    ...
    def build_optimizer(self, model, name="auto", lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        if name in {"Adam", "Adamax", "AdamW", "NAdam", "RAdam"}:
            ...
            raise NotImplementedError(
                ...
                "To request support for addition optimizers please visit https://github.com/jittoryolo/jittoryolo."
            )
