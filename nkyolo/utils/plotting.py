...
# Refer to https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/plotting.py
...
from nkyolo.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from nkyolo.utils.checks import check_font, check_version, is_ascii
from nkyolo.utils.files import increment_path


class Colors:
    """
    NK-YOLO color palette https://docs.ultralytics.com/reference/utils/plotting/#ultralytics.utils.plotting.Colors.

    This class provides methods to work with the NK-YOLO color palette, including converting hex color codes to
    RGB values.
    ...
    !!! note "NK-YOLO Brand Colors"

        For NK-YOLO brand colors see [https://www.ultralytics.com/brand](https://www.ultralytics.com/brand). Please use the official NK-YOLO colors for all marketing materials.
    """
...
class Annotator:
    """
    NK-YOLO Annotator for train/val mosaics and JPGs and predictions annotations.
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from nkyolo.utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/ultralytics/ultralytics/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from nkyolo.utils.plotting import plot_results
