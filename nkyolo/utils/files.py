...
# Refer to https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/files.py
...
def spaces_in_path(path):
    ...
    Examples:
        ...
        >>> from nkyolo.utils.files import spaces_in_path
...
def update_models(model_names=("yolo11n.pt",), source_dir=Path("."), update_names=False):
    ...
    Examples:
        ...
        >>> from nkyolo.utils.files import update_models
        >>> model_names = ("yolo11n.pt", "yolov8s.pt")
        >>> update_models(model_names, source_dir=Path("/models"), update_names=True)
    """
    from nkyolo import YOLO
    from nkyolo.nn.autobackend import default_class_names
