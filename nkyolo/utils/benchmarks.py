...
# Refer to https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/benchmarks.py

"""
Benchmark a YOLO model formats for speed and accuracy.

Usage:
    from nkyolo.utils.benchmarks import ProfileModels, benchmark
...
from nkyolo.utils.files import file_size
