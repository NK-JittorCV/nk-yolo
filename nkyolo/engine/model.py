...
from nkyolo.cfg import TASK2DATA, get_cfg, get_save_dir
from nkyolo.engine.results import Results
from nkyolo.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
...
class Model(nn.Module):
    ...
    loaded from local files, NK-YOLO HUB, or Triton Server.
    ...
    Attributes:
        ...
        session (HUBTrainingSession): The NK-YOLO HUB session, if applicable.
    ...
    def __init__(
        ...
        model sources, including local files, NK-YOLO HUB models, and Triton Server models. The method
        ...
        Args:
            model (Union[str, Path]): Path or name of the model to load or create. Can be a local file path, a
                model name from NK-YOLO HUB, or a Triton Server model.
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[nkyolo.engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pkl") -> None:
        ...
        the date, NK-YOLO version, license information, and a link to the documentation.
    ...
    def val(
        ...
        **kwargs,
        ...
        Args:
            validator (nkyolo.engine.validator.BaseValidator | None): An instance of a custom validator class for
                validating the model.
            **kwargs (Any): Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (nkyolo.utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the nkyolo.utils.benchmarks module. The benchmarking is
        ...
        """
        self._check_is_pytorch_model()
        from nkyolo.utils.benchmarks import benchmark
    ...
    def train(
        ...
        **kwargs,
        ...
        from a checkpoint, integrating with NK-YOLO HUB, and updating model and configuration after training.

        When using NK-YOLO HUB, if the session has a loaded model, the method prioritizes HUB training
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the nkyolo.nn.autobackend module. If the predictor is not
    ...
    def clear_callback(self, event: str) -> None:
        ...
        Args:
            event (str): The name of the event for which to clear the callbacks. This should be a valid event name
                recognized by the NK-YOLO callback system.
        ...
        Notes:
            - This method affects both custom callbacks added by the user and default callbacks
              provided by the NK-YOLO framework.
    ...
    def task_map(self) -> dict:
        ...
        various tasks and modes within the NK-YOLO framework.
        ...
        Note:
            ...
            classes supported by the NK-YOLO framework. The docstring provides a general
