...
# Refer to https://github.com/ultralytics/ultralytics/blob/main/ultralytics/models/yolo/detect/val.py
...
from nkyolo.data import build_dataloader, build_yolo_dataset, converter
from nkyolo.engine.validator import BaseValidator
from nkyolo.utils import LOGGER, ops
from nkyolo.utils.checks import check_requirements
from nkyolo.utils.metrics import ConfusionMatrix, DetMetrics, box_iou
from nkyolo.utils.plotting import output_to_target, plot_images
...
class DetectionValidator(BaseValidator):
    ...
    Example:
        ```python
        from nkyolo.models.yolo.detect import DetectionValidator
    ...
    def preprocess(self, batch):
        ...
        if self.args.save_hybrid:
            ...
            nb = len(batch["img"])
            bboxes = batch["bboxes"] * jt.tensor((width, height, width, height))
            self.lb = [
