from nkyolo.engine.predictor import BasePredictor
from nkyolo.engine.results import Results
from nkyolo.utils import ops
...
class DetectionPredictor(BasePredictor):
    ...
    Example:
        ```python
        from nkyolo.utils import ASSETS
        from nkyolo.models.yolo.detect import DetectionPredictor
